...
int main()
{
	...
	while (true)
	{
		...
		cout << "1 - Добавить элемент в хеш-таблицу мультипликативным методм" << endl;
		...
		case 3:
		{
			...
			cout << "Время поиска при мультипликативном хешировании в наносекундах: " << duration.count() << endl;
