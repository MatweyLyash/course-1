...
int countLeaves(Tree* root);    //Подсчет количества листьев дерева
...
void main()
{
  ...
  for (;;)
  {
    ...
    cout << "8 -  подсчёт количества листьев дерева\n";
    cout << "9 -  выход\n";
    cout << "ваш выбор?\n";
    cin >> choice;
    cout << "\n";
    ...
    case 8:
      int count1;
      count1 = countLeaves(Root);
      cout << "Kоличествo листьев дерева = " << count1 << endl;
      break;
    case 9:  exit(0);
    }
  }
